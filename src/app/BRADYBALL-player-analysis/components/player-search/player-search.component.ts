...
export class PlayerSearchComponent implements OnInit {
    ...
    private createPercentileRankModel(): void {
        ...
        const description = "Mbappe ranked 4th overall in the 2023-24 season, placing him in the 88th percentile based on the seven key attributes evaulated in the attribute overview.";
